                                ...
                                <td class="text-center">
                                    <form action="<?php echo URL_ROOT . '/admin/bookings/update/' . $booking['res_id']?>" method="post">
                                        <select onchange="this.form.submit()" name="status">
                                            <option <?php if ($booking['status'] == 'new') echo "readonly disabled selected"?> value="new">new</option>
                                            <option <?php if ($booking['status'] == 'confirmed') echo "readonly disabled selected"?> value="confirmed">confirmed</option>
                                            <option <?php if ($booking['status'] == 'canceled') echo "readonly disabled selected"?> value="canceled">canceled</option>
                                        </select>
                                    </form>
                                </td>
