<body class="d-flex flex-column vh-100 overflow-hidden">
    <div class="container-fluid d-flex flex-sm-row flex-md-column flex-grow-1 pb-3 overflow-auto">
        <div class="row flex-grow-sm-1 flex-grow-1 p-3">
            <aside class="col-sm-4 col-md-3 col-lg-2 flex-grow-sm-1 flex-shrink-1 flex-grow-0 sticky-top pb-sm-0 pb-3">
                <div class="bg-light border rounded-3 px-3 px-sm-0 p-sm-2 p-md-1 h-100 sticky-top">
                    <ul class="my-3 nav nav-pills flex-sm-column flex-row justify-content-between text-truncate align-items-center">
